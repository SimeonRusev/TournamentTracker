...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
            ...
            string prizeFileName)
        {
            ...
            // Prizes = 4
            // Rounds = 5
            //id,TournamentName,EntryFee,(id|od|od - Entered Teams), (id|id|id - Prizes), (Rounds - id^id^id|id^id^id|id^id^id)
        ...
        {
            List<MatchupEntryModel> entries = GlobalConfig.MatchupEntryFile.FullFilePath().LoadFile().ConvertToMatchupModels();
